...
func (c *searchClient) SearchIndex(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchResponse)
...
func (UnimplementedSearchServer) SearchIndex(context.Context, *SearchRequest) (*SearchResponse, error) {
